...
| **B1** single-shot | 0.6981 | 0.8352 | 0.205 | 0.8062 | 0.00171 | 11.105 |
| **B2** agent (gate) | 0.6648 | 0.8132 | 0.2475 | 0.9425 | 0.00177 | 10.513 |

**B2 − B1 high-risk recall delta: -0.022**  (macro-F1 delta: -0.0333)
...
|---|---|---|---|
| B1 single-shot (recall, any) | 0.8352 | 0.6981 | 0.205 |
| B2 detection (pre-gate) | 0.8132 | 0.6621 | 0.2475 |
| B2 verified (post-gate) | 0.8132 | 0.6648 | 0.2475 |
...
|---|---|---|---|
| B1 naive single-shot (exact-anchor) | 0.8352 | 0.4997 | no |
| B1 fair single-shot (fuzzy-anchor) | 0.8352 | 0.8062 | anchored ones only |
| B2 agent (fuzzy-anchor + gate) | 0.8132 | 0.9425 | **yes — gate rejects unanchorable** |

- **Anchorer lift:** naive → fair citation faithfulness 0.4997 → 0.8062 (same detections, better-placed citations).
...
|---|---|---|---|---|---|---|
| change_of_control | 0.6316 | 0.9231 | 0.75 | 0.0769 | 0.875 | 26 |
| uncapped_liability | 0.0286 | 0.0769 | 0.0417 | 0.9231 | 1.0 | 13 |
| auto_renewal | 0.875 | 0.875 | 0.875 | 0.125 | 0.9286 | 16 |
| non_compete | 0.6875 | 0.9565 | 0.8 | 0.0435 | 0.9091 | 23 |
| termination_for_convenience | 0.7941 | 0.931 | 0.8571 | 0.069 | 1.0 | 29 |