...
| **B1** single-shot | 0.7671 | 0.9167 | 0.0571 | 0.8033 | 0.00321 | 4.029 |
| **B2** agent (gate) | 0.7965 | 0.9583 | 0.0286 | 0.8033 | 0.00334 | 3.719 |

**B2 − B1 high-risk recall delta: +0.0417**  (macro-F1 delta: +0.0294)
...
|---|---|---|---|
| B1 single-shot (recall, any) | 0.9167 | 0.7671 | 0.0571 |
| B2 detection (pre-gate) | 0.9583 | 0.7851 | 0.0286 |
| B2 verified (post-gate) | 0.9583 | 0.7965 | 0.0286 |
...
|---|---|---|---|
| B1 naive single-shot (exact-anchor) | 0.9167 | 0.46 | no |
| B1 fair single-shot (fuzzy-anchor) | 0.9167 | 0.8033 | anchored ones only |
| B2 agent (fuzzy-anchor + gate) | 0.9583 | 0.8033 | **yes — gate rejects unanchorable** |

- **Anchorer lift:** naive → fair citation faithfulness 0.46 → 0.8033 (same detections, better-placed citations).
...
| uncapped_liability | 0.625 | 1.0 | 0.7692 | 0.0 | 0.6 | 5 |
| auto_renewal | 0.5714 | 1.0 | 0.7273 | 0.0 | 0.75 | 4 |
| non_compete | 1.0 | 0.8571 | 0.9231 | 0.1429 | 1.0 | 7 |
