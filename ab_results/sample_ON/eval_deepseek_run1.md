...
| **B1** single-shot | 0.7543 | 0.9167 | 0.0686 | 0.8333 | 0.00324 | 4.154 |
| **B2** agent (gate) | 0.7994 | 0.9167 | 0.0686 | 0.7833 | 0.0032 | 3.819 |

**B2 − B1 high-risk recall delta: +0.0**  (macro-F1 delta: +0.0451)
...
|---|---|---|---|
| B1 single-shot (recall, any) | 0.9167 | 0.7543 | 0.0686 |
| B2 detection (pre-gate) | 0.9167 | 0.7536 | 0.0686 |
| B2 verified (post-gate) | 0.9167 | 0.7994 | 0.0686 |
...
| B2 agent (fuzzy-anchor + gate) | 0.9167 | 0.7833 | **yes — gate rejects unanchorable** |
...
| uncapped_liability | 0.5714 | 0.8 | 0.6667 | 0.2 | 0.5 | 5 |
