...
| **B1** single-shot | 0.6677 | 0.7912 | 0.2724 | 0.9545 | 0.006 | 18.806 |
| **B2** agent (gate) | 0.6492 | 0.6703 | 0.3517 | 0.9765 | 0.00614 | 18.679 |

**B2 − B1 high-risk recall delta: -0.1209**  (macro-F1 delta: -0.0184)
...
|---|---|---|---|
| B1 single-shot (recall, any) | 0.7912 | 0.6677 | 0.2724 |
| B2 detection (pre-gate) | 0.7912 | 0.6757 | 0.2649 |
| B2 verified (post-gate) | 0.6703 | 0.6492 | 0.3517 |

**Gate gap (detection − verified high-risk recall): +0.1209** — target ≈ 0 (the gate keeps what the detector found).
...
|---|---|---|---|
| B1 naive single-shot (exact-anchor) | 0.7912 | 0.6077 | no |
| B1 fair single-shot (fuzzy-anchor) | 0.7912 | 0.9545 | anchored ones only |
| B2 agent (fuzzy-anchor + gate) | 0.6703 | 0.9765 | **yes — gate rejects unanchorable** |

- **Anchorer lift:** naive → fair citation faithfulness 0.6077 → 0.9545 (same detections, better-placed citations).
...
| uncapped_liability | 0.0833 | 0.0769 | 0.08 | 0.9231 | 1.0 | 13 |
| auto_renewal | 1.0 | 0.875 | 0.9333 | 0.125 | 1.0 | 16 |
| non_compete | 0.85 | 0.7391 | 0.7907 | 0.2609 | 0.9412 | 23 |
| termination_for_convenience | 0.7429 | 0.8966 | 0.8125 | 0.1034 | 1.0 | 29 |